...
#   "uring_sender_multi_thread_gsro.json",
    "uring_sender_multi_thread_ring_size.json", # ONLY ADDITIONAL CONFIG AS SANITY CHECK
    "uring_sender_multi_thread_ring_size_gsro.json", # ONLY ADDITIONAL CONFIG AS SANITY CHECK
...
#   "uring_sender_single_thread_ring_size.json",
    ...
    "uring_receiver_multi_thread_ring_size.json", # ONLY ADDITIONAL CONFIG AS SANITY CHECK
    "uring_receiver_multi_thread_ring_size_gsro.json", # ONLY ADDITIONAL CONFIG AS SANITY CHECK
